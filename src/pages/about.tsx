...
const About = () => (
  <div className="text-gray-600 antialiased">
    <Meta
      ...
      description="了解 ZFly 的发展历程、企业文化和技术团队。"
    />
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-12 rounded-lg bg-white p-8 shadow-md">
            ...
            <p className="mb-4 text-lg leading-relaxed">
              ZFly 成立于 2020
              年，是一家专注于高性能工业级无人机研发、制造与销售的科技创新型企业。我们拥有一支由资深航空航天工程师、AI
              算法专家和结构设计师组成的研发团队。
            </p>
            <p className="text-lg leading-relaxed">
              我们的产品广泛应用于电力巡检、农业植保、安防救援、地理测绘等领域，以&quot;稳定、智能、高效&quot;著称。ZFly
              始终坚持技术驱动，不断突破飞行边界，为各行各业提供可靠的空中生产力工具。
            </p>
          </div>
          ...
          <div className="rounded-lg bg-white p-8 shadow-md">
            <h2 className="mb-6 text-2xl font-bold text-gray-900">发展历程</h2>
